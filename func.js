...
//		d3.json(function(data1) {
	...
	tooltip: {
        format: {
			 title: function (name, ratio, id, index) {return name},
			 name: function (name, ratio, id, index) { return ('Incident Percentage');},
			 value: function (name, ratio, id, index) {return d3.format('%')(d3.format(".2g")(name));}
			}
		},
		axis: {
			x: {
